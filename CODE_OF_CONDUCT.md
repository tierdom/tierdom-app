# Contributor Covenant 3.0 Code of Conduct (Adapted)

An adaptation of the covenant is included for Tierdom from the start.
Since it is a solo-maintainer endeavor at the time of writing, it might seem a bit overkill.
And although technically _is_, the spirit of the covenant ("be kind to each other") is something that I endorse strongly.
So we might as well rely on a well-written template, adapted where needed.
...
## Reporting an Issue; Addressing and Repairing Harm
...
To report a possible violation, **contact https://jeroenheijmans.nl**

Since Tierdom is a solo endeavor at the time of writing, we adapt the covenant at this point.
Until a time when this project attracts a larger community, contacting the core maintainer and engaging in personal interaction is the way to resolve an issue.
