...
export const CATEGORIES: SeedCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Chrono Trigger', score: 96, props: [p('Platform', 'SNES')] },
      { name: 'Final Fantasy VII', score: 95, props: [p('Platform', 'PS1')] },
      { name: 'The Witcher 3', score: 94, props: [p('Platform', 'PC')] },
      { name: 'Super Mario 64', score: 93, props: [p('Platform', 'N64')] },
      {
        name: 'Disco Elysium',
        score: 92,
        props: [p('Platform', 'PC')],
      ...
      { name: 'Halo: Combat Evolved', score: 90, props: [p('Platform', 'Xbox')] },
      { name: 'Mass Effect 2', score: 89, props: [p('Platform', 'Xbox 360')] },
      { name: 'Dark Souls', score: 88, props: [p('Platform', 'PS3')] },
      { name: 'Resident Evil 4', score: 87, props: [p('Platform', 'GameCube')] },
      { name: 'Celeste', score: 86, props: [p('Platform', 'Switch')] },
      { name: 'Red Dead Redemption 2', score: 85, props: [p('Platform', 'PS4')] },
      { name: 'Tetris', score: 84, props: [p('Platform', 'Game Boy')] },
      { name: 'Elden Ring', score: 83, props: [p('Platform', 'PC')] },
      { name: 'Stardew Valley', score: 82, props: [p('Platform', 'PC')] },
      {
        name: 'The Legend of Zelda: A Link Between Worlds',
        score: 81,
        props: [p('Platform', '3DS')],
      },
      { name: 'Outer Wilds', score: 80, props: [p('Platform', 'PC')] },
      { name: 'Pokémon Crystal', score: 79, props: [p('Platform', 'Game Boy Color')] },
      { name: 'Divinity: Original Sin 2', score: 78, props: [p('Platform', 'PC')] },
      { name: 'Shadow of the Colossus', score: 77, props: [p('Platform', 'PS2')] },
      { name: 'Sekiro', score: 76, props: [p('Platform', 'PC')] },
      { name: 'Metroid Fusion', score: 75, props: [p('Platform', 'Game Boy Advance')] },
      { name: 'Inside', score: 74, props: [p('Platform', 'PC')] },
      { name: 'Mario Kart DS', score: 73, props: [p('Platform', 'DS Lite')] },
      { name: 'Cuphead', score: 72, props: [p('Platform', 'PC')] },
      { name: 'Shenmue', score: 71, props: [p('Platform', 'Dreamcast')] },
      { name: 'Monster Hunter: World', score: 70, props: [p('Platform', 'PC')] },
      { name: 'Sonic the Hedgehog 2', score: 69, props: [p('Platform', 'Mega Drive')] },
      { name: 'Dragon Age: Origins', score: 68, props: [p('Platform', 'PC')] },
      { name: 'Super Mario Bros. 3', score: 67, props: [p('Platform', 'NES')] },
      { name: 'Forza Horizon 4', score: 66, props: [p('Platform', 'Xbox One')] },
      { name: 'Subnautica', score: 65, props: [p('Platform', 'PC')] },
      { name: 'Wii Sports', score: 64, props: [p('Platform', 'Wii')] },
      { name: 'Fallout: New Vegas', score: 63, props: [p('Platform', 'PC')] },
      { name: 'Bayonetta 2', score: 62, props: [p('Platform', 'Wii U')] },
      { name: 'Beat Saber', score: 61, props: [p('Platform', 'Oculus')] },
      { name: 'The Talos Principle', score: 60, props: [p('Platform', 'PC')] },
      { name: 'Vampire Survivors', score: 59, props: [p('Platform', 'Steam Deck')] },
      { name: 'A Short Hike', score: 58, props: [p('Platform', 'PC')] },
      { name: 'NiGHTS into Dreams', score: 57, props: [p('Platform', 'Saturn')] },
      { name: 'Lemmings', score: 56, props: [p('Platform', 'Amiga')] },
      { name: 'Mario Kart World', score: 55, props: [p('Platform', 'Switch 2')] },
      { name: 'Pitfall!', score: 54, props: [p('Platform', 'Atari')] },
      { name: "The Bard's Tale", score: 53, props: [p('Platform', 'Commodore 64')] },
